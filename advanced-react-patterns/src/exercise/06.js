...
function useToggle({
  ...
  if(process.env.NODE_ENV !== 'production') {
    // we can  disable eslint warning because we know that the
    // process.env.NODE_ENV value will not change during the life time of
    // the app + it wont be included on the prod build
